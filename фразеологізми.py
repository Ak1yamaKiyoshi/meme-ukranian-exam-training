import pprint
st1r = """Авгієві стайні - щось дуже занедбане, повне безладдя.
...
user_answer_positive = 0
unknown = []
for index, i in enumerate(st1r.split("\n")):
    if len(i) > 1:
        phrase = i[:i.find("-")]
        explanation = i[i.find("-"):]
        print("" 
              + '\033[0m' # normal 
              + '\033[93m' # yellow
              + f"\n{explanation[2:-1]}"
        ...
        user_answer = input("know? y/n: ")
        if "n" in user_answer:
            user_answer_negative += 1
            unknown.append(i)
...
print(""
      +        '\033[1m' +'\033[95m' + "____________________"
      + '\n' + '\033[1m' + '\033[92m' + "positive     ->  " + f"{user_answer_positive}"
      + '\n' + '\033[1m' + '\033[91m' + "negative     ->  " + f"{user_answer_negative}"
      + '\n' + '\033[1m' + '\033[93m' + "total        ->  " + f"{user_answer_positive + user_answer_negative}"
      + '\n' + '\033[1m' + '\033[94m' + "not answered ->  " + f"{240 - (user_answer_positive + user_answer_negative)}"
      + '\033[0m'
      )

print(f" print unknown? ")
if input("y/n: ") == "y":
    print( '\033[91m' + f"{unknown}"+ '\033[0m')
